...
internal class ManagerAllContactConfiguration : IEntityTypeConfiguration<ManagerAllContact>
{
    public void Configure(EntityTypeBuilder<ManagerAllContact> builder)
    {
