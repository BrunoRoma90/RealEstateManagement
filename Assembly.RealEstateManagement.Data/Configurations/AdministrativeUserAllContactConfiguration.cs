...
internal class AdministrativeUserAllContactConfiguration : IEntityTypeConfiguration<AdministrativeUserAllContact>
{
    public void Configure(EntityTypeBuilder<AdministrativeUserAllContact> builder)
    {
